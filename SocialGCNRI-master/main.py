...
try:
    ...
    print(f"\nbest recall at normal:{best_recall}")
    print(f"best ndcg at normal:{best_ndcg}")
    print(f"best precision at normal:{best_pre}")
    print(f"\nbest recall at cold:{best_recall_cold}")
    print(f"best ndcg at cold:{best_ndcg_cold}")
    print(f"best precision at cold:{best_pre_cold}")
