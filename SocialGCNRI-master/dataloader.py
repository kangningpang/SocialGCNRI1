    ...
    def getInteractionGraph(self):
        if self.interactionGraph is None:
            try:
                ...
                norm2_adj = sp.load_npz(f'./data/preprocessed/{self.src}/interaction_adj_mat.npz')
                norm3_adj = sp.load_npz(f'./data/preprocessed/{self.src}/interaction_adj_mat.npz')
                ...
                adj2_mat[self.n_user:,:self.n_user]=R
                adj2_mat[self.n_user:, self.n_user:] = I_I
                adj2_mat[:self.user,self.n_user:]=R.T
